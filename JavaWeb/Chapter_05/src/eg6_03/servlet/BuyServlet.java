...
import eg6_03.toolbean.MyTools;
import eg6_03.toolbean.ShopCar;
import eg6_03.valuebean.GoodsSingle;
...
public class BuyServlet extends HttpServlet {
	...
	protected void buy(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect(request.getContextPath()+"/6_03/show.jsp");				//将请求重定向到show.jsp页面
	}
	//实现移除商品的方法
	protected void remove(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect(request.getContextPath()+"/6_03/shopcar.jsp");
	}
	//实现清空购物车的方法
