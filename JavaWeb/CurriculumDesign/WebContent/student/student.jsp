...
function WriteStList(studentList){
	...
	for(var i=0;i<studentList.length;i++){
		...
		strHtml+="<td><a href=\"JavaScript:show_input("+studentList[i]["id"]+")\">编辑</a>";
		strHtml+="<a href=\"JavaScript:delData("+studentList[i]["id"]+")\">删除</a></td></tr>";	
	}
	strHtml+="</table>";	
...
<div id="studentsSpan" ></div>	
		...
		<table width="100%"  border="0" cellpadding="0" cellspacing="0" align="center">	
			<tr><td colspan="4"><a href="JavaScript:show_input(-1);">添加学生信息</a>
...
<div id="studentsEditDiv" style="display:NONE" class="divcss5">
   ...
   <tr><td>学号</td><td><input type="text" name="code" id="code" value="" size="20" maxlength="5" onchange="checkCode();"><span class="star">*</span>5位字符数字<span id="codeSpan"></span></td></tr>
   ...
   <tr><td>备注</td><td><TEXTAREA name="detail"  id="detail"  rows="2" cols="20" onpropertychange="if(this.value.length>200) {this.value=value.substr(0,200);alert('描述最多20个字符!');}"></TEXTAREA>200个字符以内</td></tr>
