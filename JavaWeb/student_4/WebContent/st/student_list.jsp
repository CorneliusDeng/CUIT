...
function WriteStList(data){
	...
	for(var i=0;i<studentList.length;i++){
		...
		strHtml+="<td><a href=\"<%=path %>/servlet/StudentGetAction?id="+studentList[i]["id"]+"\">编辑</a>";
		strHtml+="<a href=\"<%=path %>/servlet/StudentDelAction?id="+studentList[i]["id"]+"\">删除</a></td></tr>";	
		strHtml+="</table>";	
	}
