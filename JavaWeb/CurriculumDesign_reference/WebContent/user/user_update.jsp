...
<body>
	...
	user = beanDB.select(userId);
	%> 							 
	<form name="frm" method="post" action="<%=request.getContextPath()%>/UserUpdateAction">
		<table weight="100%" border=1 align="center">
	        ...
	        <tr>
	            ...
	            <td>
	                ...
	                <input type="text" name="name" onchange="checkName();" value="<%=user.getUserName() %>">
	        ...
	        <tr>
	            <td>密码</td>
	            <td>
	            	<input type="password" name="password" value="<%=user.getUserPwd() %>">
	            	<font color="FF2B21">*</font>
	            </td>
	        </tr>
	        <tr>
