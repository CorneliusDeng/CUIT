...
<script type="text/javascript" src = "<%=path%>/js/datacheck.js"></script>
  ...
  <center>									 
   ...
   <tr><td><input type="text" name="code" value="" size="20" maxlength="5"></td><td><input type="button"  value="查询" onclick="return check();"></td></tr>
   </table>   
   </form>
      ...
      if (http_request.status == 200) { // 正常响应
	    ...
	    if (scores.length != 0) {
		   ...
		   //	alert(html);
	    	...
	    	document.getElementById("dataTable").innerHTML="改学号不存在，或者该学生没有成绩信息！";
	    }
