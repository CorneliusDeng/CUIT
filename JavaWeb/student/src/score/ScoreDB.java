...
public class ScoreDB {
    ...
    public ArrayList<ScoreInfo> getStudentScoresByAjax(String stCode) {
        ...
        try {
            ...
            sql+="from t_score a,t_course b ,t_student c ";
            sql+="where c.VC_STUDENT_CODE='"+stCode+"' and a.N_STUDENT_ID=c.N_STUDENT_ID and a.N_COURSE_ID=b.N_COURSE_ID ";	
    ...
    public ArrayList<ScoreInfo> getCourseScoresByAjax(int courseID) {
        ...
        try {
            ...
            sql+="from t_score a,t_student b ";
