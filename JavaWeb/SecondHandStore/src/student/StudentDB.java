...
public class StudentDB 
{
    ...
    public ArrayList<StudentInfo> getAllStudents() {
        ...
        try {
	    	...
	    	rs=sql.executeQuery("SELECT * from td_order");
	    	while(rs.next()){
	    		StudentInfo student=new StudentInfo();
	    		student.setStID(rs.getInt("order_id"));
	    		student.setStCode(rs.getInt("com_id"));
	    		student.setStName(rs.getInt("user_id"));
	    		student.setSex(rs.getString("order_status"));
	    		student.setGrade(rs.getString("order_time"));
