 ...
 */
@WebServlet("/ChatServletXML")
public class ChatServletXML extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public ChatServletXML() {
        super();
    }
	...
	public void get(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException{
		response.setContentType("text/xml;charset=UTF-8");	//设置响应的内容类型及编码方式
		...
		if(null!=application.getAttribute("message")){
			...
			for(int i=v_temp.size()-1;i>=0;i--){
				out.println("<message>"+v_temp.get(i)+"</message>");
			}
		}else{
			out.println("<message>欢迎光临碧海聆音聊天室！</message>");
		}
		out.println("</chat>");
