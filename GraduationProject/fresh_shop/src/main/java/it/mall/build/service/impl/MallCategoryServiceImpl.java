...
import it.mall.build.common.MallCategoryLevelEnum;
...
import it.mall.build.controller.vo.SecondLevelCategoryVO;
import it.mall.build.controller.vo.ThirdLevelCategoryVO;
import it.mall.build.mapper.GoodsCategoryMapper;
            ...
            if (!CollectionUtils.isEmpty(secondLevelCategories)) {
                ...
                if (!CollectionUtils.isEmpty(thirdLevelCategories)) {
                    ...
                    if (!CollectionUtils.isEmpty(secondLevelCategoryVOS)) {
                        //根据 parentId 将 secondLevelCategory 分组
