<template>
	<view>
		...
		<image @click="goBack()" class="icon-back" src="../../static/base_icons/back_white.svg"></image>
		<image @click="" class="icon-option" src="../../static/base_icons/options_white.svg"></image>
		<view class="header">
		...
		onLoad(params) {
			...
			uni.request({
				...
				success(res) {
					...
					//请求用户的全部Blog
					uni.request({
						// url:"http://192.168.31.221:8081/allhisblogs",
						url: _this.domain + "/allhisblogs",
						data:{
							blogerID:blogerID,
